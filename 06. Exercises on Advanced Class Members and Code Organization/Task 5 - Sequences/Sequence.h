...
template<typename T, typename Generator>
inline void Sequence<T, Generator>::generateNext(int number)
{
	this->numbers.push_back(this->generator());
}

template<typename T, typename Generator>
inline std::vector<int>::iterator Sequence<T, Generator>::begin()
{
	return this->numbers.begin();
}

template<typename T, typename Generator>
inline std::vector<int>::iterator Sequence<T, Generator>::end()
{
